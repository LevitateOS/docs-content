			...
			content: [
				{
					...
					items: [
						...
						rich`${bold("Bootloader")} - Copy pre-built UKI, install systemd-boot`,
			...
			content: [
				{
					...
					items: [
						...
						rich`${link("Bootloader & Finish", "/docs/installation-boot")} - Copy UKI, install bootloader, enable services, reboot (steps 15-18)`,
					],
				},
			],
		},
